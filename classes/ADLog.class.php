...
class ADLog
{
    ...
    */
    public function Info($message, $file=null, $method=null, $lineNr=null)
    {
        ...
        if(in_array("All", $this->saveLevels)) $this->Save("All", $line);
        if(in_array("Info", $this->saveLevels)) $this->Save("Info", $line);
    }
    ...
    */
    public function Debug($message, $file=null, $method=null, $lineNr=null)
    {
        ...
        if(in_array("All", $this->saveLevels)) $this->Save("All", $line);
        if(in_array("Debug", $this->saveLevels)) $this->Save("Debug", $line);
    }
    ...
    */
    public function Warn($message, $file=null, $method=null, $lineNr=null)
    {
        ...
        if(in_array("All", $this->saveLevels)) $this->Save("All", $line);
        if(in_array("Warn", $this->saveLevels)) $this->Save("Warn", $line);
    }
    ...
    */
    public function Fatal($message, $file=null, $method=null, $lineNr=null)
    {
        ...
        if(in_array("All", $this->saveLevels)) $this->Save("All", $line);
        if(in_array("Fatal", $this->saveLevels)) $this->Save("Fatal", $line);
    }
    ...
    */
    public function Conn($message, $file=null, $method=null, $lineNr=null)
    {
        ...
        if(in_array("All", $this->saveLevels)) $this->Save("All", $line);
        if(in_array("Conn", $this->saveLevels)) $this->Save("Conn", $line);
    }	
