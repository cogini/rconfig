...
function deviceOrCatSelect() {
    ...
    if (chosen == "deviceSelectRadio") { // if value = "deviceSelectRadio"
        ...
        document.getElementById("catSelect").selectedIndex = -1; // disbale any selections made in the 'catSelect' selection list
        ...
        document.getElementById("deviceSelect").selectedIndex = -1; // disbale any selections made in the 'deviceSelect' selection list
...
// chnage list of commands in select box based on categories selection - only when run report is selected
function changeType() {
