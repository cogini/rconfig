		...
		<div id="content">
			...
			<fieldset id="tableFieldset">
				...
				<?php 
					...
					if(isset($errors['selectRadioErr'])){echo "<span class=\"error\">".$errors['selectRadioErr']."</span>";}
				?>
				<div id="toolbar">
				...
				<div class="mainformDiv">
					<form id="elementAddForm" name="elementAddForm" method="post" action="lib/crud/compliancepolicyelements.crud.php" enctype="multipart/form-data" class="myform stylizedForm stylized" style="width:100%;">
						...
						<div>
							...
							<input name="elementName" id="elementName" size="75" tabindex='1' <?php if(isset($errors['elementNameVal'])){ echo 'value="'.$errors['elementNameVal'].'"';}?>>
							<div  id="errorDiv" style="float:left;margin-left:220px; margin-top:-10px; margin-bottom:10px;">
							<?php if(isset($errors['elementName'])){echo "<span class=\"error\">".$errors['elementName']."</span>";}?>
							</div>
						</div>
						<div style="float:left;">
							<label for="elementDesc"><font color="red">*</font> Element Description:</label>
							<input name="elementDesc" id="elementDesc" size="150" tabindex='2'  <?php if(isset($errors['elementDescVal'])){ echo 'value="'.$errors['elementDescVal'].'"';}?>>
							<div id="errorDiv" style="float:left;margin-left:220px; margin-top:-10px; margin-bottom:10px;">
							<?php if(isset($errors['elementDesc'])){echo "<span class=\"error\">".$errors['elementDesc']."</span>";}?>
							</div>
						</div>
						...
						<div style="clear:both">
							...
							<input type="text" id="singleLine1" name="singleLine1" tabindex='6' style="width:345px;" <?php if(isset($errors['singleLine1val'])){ echo 'value="'.$errors['singleLine1val'].'"';}?>/>

							<div class="spacer"></div>
							<div  id="errorDiv" style="float:left;margin-left:77px; margin-top:-10px; margin-bottom:10px;">
								<?php if(isset($errors['singleLine1'])){echo "<span class=\"error\">".$errors['singleLine1']."</span>";}?>
							</div>						
						</div>
