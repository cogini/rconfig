				...
				<div class="mainformDiv">
					<form id="reportsAddForm" name="reportsAddForm" method="post" action="lib/crud/compliancereports.crud.php" enctype="multipart/form-data" class="myform stylizedForm stylized" style="width:100%;">
						...
						<div>
							...
							<input name="reportsName" id="reportsName" size="75" tabindex='1' <?php if(isset($errors['reportsNameVal'])){ echo 'value="'.$errors['reportsNameVal'].'"';}?>>
							<div  id="errorDiv" style="float:left;margin-left:220px; margin-top:-10px; margin-bottom:10px;">
							<?php if(isset($errors['reportsName'])){echo "<span class=\"error\">".$errors['reportsName']."</span>";}?>
							</div>
						</div>
						<div style="float:left;">
							<label for="reportsDesc"><font color="red">*</font> Report Description:</label>
							<input name="reportsDesc" id="reportsDesc" size="150" tabindex='2'  <?php if(isset($errors['reportsDescVal'])){ echo 'value="'.$errors['reportsDescVal'].'"';}?>>
							<div id="errorDiv" style="float:left;margin-left:220px; margin-top:-10px; margin-bottom:10px;">
							<?php if(isset($errors['reportsDesc'])){echo "<span class=\"error\">".$errors['reportsDesc']."</span>";}?>
							</div>
						</div>
						...
						<?php if(isset($errors['selectedPolicies'])){echo "<span class=\"error\" style=\"padding-left:252px\">".$errors['selectedPolicies']."</span>";}?>
