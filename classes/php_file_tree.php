...
/*SS NOTES
added $chkOn arguemnt, to append the file output <li> with a checkbox selection
$chkOn = true, adds the checkbox
*/
function php_file_tree($directory, $return_link, $extensions = array(), $chkOn = false) {
	// SS - initalise $code as appears to throw an error for unknown reason
	$code = "";
...
// SS - initalise $php_file_tree as appears to throw an error somtimes for unknown reason
$php_file_tree = ''; 
