				...
				<div class="mainformDiv">
					<form id="policyAddForm" name="policyAddForm" method="post" action="lib/crud/compliancepolicies.crud.php" enctype="multipart/form-data" class="myform stylizedForm stylized" style="width:100%;">
						...
						<div>
							...
							<input name="policyName" id="policyName" size="75" tabindex='1' <?php if(isset($errors['policyNameVal'])){ echo 'value="'.$errors['policyNameVal'].'"';}?>>
							<div  id="errorDiv" style="float:left;margin-left:220px; margin-top:-10px; margin-bottom:10px;">
							<?php if(isset($errors['policyName'])){echo "<span class=\"error\">".$errors['policyName']."</span>";}?>
							</div>
						</div>
						<div style="float:left;">
							<label for="policyDesc"><font color="red">*</font> Policy Description:</label>
							<input name="policyDesc" id="policyDesc" size="150" tabindex='2'  <?php if(isset($errors['policyDescVal'])){ echo 'value="'.$errors['policyDescVal'].'"';}?>>
							<div id="errorDiv" style="float:left;margin-left:220px; margin-top:-10px; margin-bottom:10px;">
							<?php if(isset($errors['policyDesc'])){echo "<span class=\"error\">".$errors['policyDesc']."</span>";}?>
							</div>
						</div>
						...
						<?php if(isset($errors['selectedElems'])){echo "<span class=\"error\" style=\"padding-left:252px\">".$errors['selectedElems']."</span>";}?>
