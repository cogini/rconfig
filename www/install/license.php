...
?>	
		...
		<h2>License Agreement</h2>
			...
			<div id="section">
			<p>
				Please read the terms of your license carefully below. By contiuing with the installation of rConfig, you declare that you agree to the terms of this license agreement in full
				</p>
				<div id="licenseDiv">
				<p>
				<?php 
