<?php include("includes/head.inc.php"); ?>
	<body>
		...
		<div id="forgotPasswordForm" class="myform stylizedForm stylized">
			...
			if(isset($errors['curpass'])){echo "<span class=\"error\">".$errors['curpass']."</span>";}
			else {
			...
			<?php	// echo error message if is sent back in GET from CRUD
			if(isset($errors['password'])){echo "<span class=\"error\">".$errors['password']."</span>";}
			else {
			...
			<?php	// echo error message if is sent back in GET from CRUD
			if(isset($errors['passconf'])){echo "<span class=\"error\">".$errors['passconf']."</span>";} 
			else {
